      ...
      <div className='w-full'>
        ...
        <div>
              ...
              <Swiper {...sliderConfigProduct} className='mySwiper rounded-[5px]'>
                {initialProductRecommendData.map((product) => (
                  <SwiperSlide key={product._id}>
                    <CardProduct products={product} handleAddToCart={() => handleAddToCart(product?._id, user?._id)} />
                  </SwiperSlide>
                ))}
              </Swiper>
            </div>
          ...
          <div className='flex items-center justify-between bg-[#F3F8FB] mt-[70px] rounded-md px-4'>
            <div className='p-5'>
              <h1 className='font-bold text-[25px] py-5'>
                Giới thiệu webiste đặt thuốc online
                <span className='text-[#2563EB] pl-2'>Bình An Dược</span>
              </h1>

              <p className='w-[850px] text-[14px]'>
                Website <span className='text-[#2563EB] font-semibold'>Bình An Dược</span> mang trong mình sứ mệnh chăm
                sóc sức khỏe cho hàng triệu người dân Việt Nam. Chúng tôi luôn không ngừng nâng cao dịch vụ để mang lại
                chất lượng và trải nghiệm tốt nhất cho khách hàng.
              </p>
              <p className='w-[850px] text-[14px] pt-4'>
                Với khát vọng trở thành nền tảng y tế từ xa uy tín, chất lượng hàng đầu Việt Nam và tương lai là vươn ra
                thế giới, <span className='text-[#2563EB] font-semibold'>Bình An Dược</span> không ngừng nỗ lực, sáng
                tạo để mang lại cho người dùng dịch vụ chăm sóc sức khỏe nhanh chóng và chất lượng nhất.
              </p>
            </div>
            <div>
