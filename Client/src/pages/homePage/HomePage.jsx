      ...
      <div className="w-full">
        ...
        <div>
          ...
          <div className="flex justify-between mt-[50px]">
            ...
            <Advertisement image={"https://www.medigoapp.com/assets/images-html/icon-support-popup-img.png"} title={"GIAO THUỐC NHANH"} description={"Bình An Dược chỉ hoạt động với các hiệu thuốc đạt chuẩn GPP và được cấp phép của Bộ Y Tế"} />
