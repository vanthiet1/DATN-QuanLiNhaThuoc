            ...
            {initialCategoryData &&
              initialCategoryData.map((category) => (
                <CardCategory
                  ...
                  image={
                    category.image || 'https://www.medigoapp.com/assets/images-html/suc-khoe-sinh-san-category.png'
                  }
                />
              ))}
          </div>
                ...
                initialProductRecommendData.map((newProduct) => (
                  <div key={newProduct._id}>
                    <CardProduct
                      ...
                      image={
                        newProduct?.images[0]?.url_img ||
                        'https://files.oaiusercontent.com/file-IPwu8S65s4cwPOR4Zr0PlI3T?se=2024-10-05T09%3A36%3A42Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3D6fc820c0-e22c-468f-9e9c-1fd1e1924ba3.webp&sig=hnxYedfodtMQk%2BHnD3lYe%2BJ2lVaA5lJM80muqMZN6Vo%3D'
                      }
