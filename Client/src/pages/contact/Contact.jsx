...
const Contact = () => {
  return (
    <div>
      ...
      <div className='flex w-[1300px] bg-white shadow-lg rounded-lg overflow-hidden'>
        <div className='w-1/2'>
          <iframe
          ...
          <div className='flex items-center mb-6'>
            ...
            <div>
              <div className='flex mb-2'>
                <IoLocation className='text-[#2563EB] w-10 h-5 mr-1' />
                <p className='flex text-base'> 116 Nguyễn Huy Tưởng, Hoà An, Liên Chiểu, TP.Đà Nẵng</p>
              </div>
              <div className='flex mb-2'>
                <FaPhoneVolume className='text-[#2563EB] w-10 h-4 mr-1' />
                <p className='flex text-base'> 076 922 0162</p>
              </div>
              <div className='flex mb-2'>
                <IoMdMail className='text-[#2563EB] w-10 h-5 mr-1' />
                <p className='flex text-base'>binhanduoc@gmail.com</p>
              </div>

              <div className='flex mb-2'>
                <FaFacebook className='text-[#2563EB] w-10 h-5 mr-1' />
