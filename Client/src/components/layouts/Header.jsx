    ...
    <div className={`ease-in-out sticky top-0 z-30`}>
          ...
          <div className='flex items-center justify-between p-2 w-[90%] m-auto max-md:w-full '>
            <div className='flex gap-2 items-center  max-md:flex-col'>
              ...
              <div className='relative max-md:w-full max-md:absolute max-md:left-0 max-md:top-[55px]'>
                <div
                  className='absolute top-1/2 left-5 transform -translate-x-1/2 -translate-y-1/2 '
                  onClick={handleSearchQueryProduct}
                >
                  <AppIcons.SearchIcons addClassNames='text-[#a8a8a8] text-[20px] ' />
                </div>
                <InputText
                  onChange={handleChange}
                  addClassNames={'max-md:w-full rounded-[5px] w-[400px] h-[50px] pl-[10px] text-[16px]'}
                ...
                <>
                  <div className='flex items-center gap-3'>
                    <Button
                      ...
                      addClassNames='text-[16px] text-[#fff] font-normal '
                    >
                      Đăng nhập
                    </Button>
                    <Button
      ...
      <nav>
        <div className=' border-1 w-[100%] p-4 shadow-lg bg-[#fff] max-md:mt-[40px]  '>
          <div className='cursor-pointer hidden max-md:block' onClick={() => setIsShowCategory(!isShowCategory)}>
            <div className='flex items-center justify-between'>
              <div className='flex items-center gap-3'>
                <AppIcons.CategoryIcon addClassNames='text-[#2563eb]' />
                <span className='text-[#2563eb] font-semibold'>Xem Tất Cả Danh Mục Thuốc</span>
              </div>
              <AppIcons.ArrowDown
                addClassNames={`bg-[#2563eb] rounded-[50%] transition-transform duration-300 ${
          ...
          <div
            className={` ${
              !isShowCategory ? 'max-md:overflow-hidden max-md:h-0' : 'max-md-max-h-100'
            } flex justify-between items-center gap-2 w-[90%] max-md:w-full m-auto max-md:flex-col`}
          >
            {initialCategoryData &&
              initialCategoryData.map((category) => (
                <div
                  className='flex items-center group relative max-md:flex max-md:justify-between max-md:w-full max-md:pt-4 '
                  key={category._id}
                >
            ...
            <div className='flex items-center group relative max-md:flex max-md:justify-between max-md:w-full'>
              <span className='w-max cursor-pointer hover:text-[#2563EB] duration-200 text-[15px] font-semibold max-md:pt-4'>
                Góc sống khỏe
              </span>
              <div className='ml-3'>
                <AppIcons.ArrowDown addClassNames='inline-block ml-1 transition-transform duration-300 group-hover:rotate-180 group-hover:text-[#2563EB]' />
