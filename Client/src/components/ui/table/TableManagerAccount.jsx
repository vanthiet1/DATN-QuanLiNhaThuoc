...
const Table = ({ data, addClassNames, titleRow, cols, styleRows , handleDelete , handleIsActiveAccount }) => {
 console.log(data);
            ...
            <tr key={data._id} className='border-b border-gray-300 hover:bg-gray-50'>
                ...
                <td className='p-3'>
                    <span className={`inline-flex px-2 text-xs font-medium leading-5 rounded-full 
                        ...
                        data.emailVerify === true ? 'px-3 py-1 rounded-full dark:bg-green-700 dark:text-white' : ""}`}>
